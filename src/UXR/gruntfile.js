...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            // - dest: to use BundlerForBower.cs you need to save the file into a set directory and with the same name as the property
            css: {
        ...
        watch: {
            ...
            css: {
                files: ['bower_components/**/*.css', 'Content/**/*.css'],
                tasks: ['build:css'],
                options: {
                    spawn: false,
                },
    ...
    // Build task(s).
    grunt.registerTask('build', ['build:css', 'build:js', 'copy']);
